...
export default class Index extends Component {
  ...
  componentWillMount() {
    ...
    const params = { status: 1, storeId: 0, ruleType: 1, pageNum: 1, pageSize: 999  }
    Taro.showLoading()
  ...
  chooseCoupon(item) {
    ...
    if (id == 1002 || id == '1002') {
      Taro.setStorageSync('platCouponInfo', couponInfo)
    } else {
            ...
            {couponList.length > 0 ? (
              <Block>
                ...
                <View className="no-data-view">
                  ...
                  ></Image>
                  <View className="no-data-text">没有可用的优惠券
